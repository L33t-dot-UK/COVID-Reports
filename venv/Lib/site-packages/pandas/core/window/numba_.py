...
def generate_numba_table_func(
    ...
    Func will be passed a M window size x N number of columns list, and
    must return a 1 x N number of columns list. Func is intended to operate
