...
class BaseStringArrayMethods(abc.ABC):
    """
    Base class for extension lists implementing string methods.

    This is where our ExtensionArrays can override the implementation of
    Series.str.<method>. We don't expect this to work with
    3rd-party extension lists.

    * User calls Series.str.<method>
    * pandas extracts the extension list from the Series
    * pandas calls ``extension_list._str_<method>(*args, **kwargs)``
