...
class Apply(metaclass=abc.ABCMeta):
    ...
    def _try_aggregate_string_function(self, obj, arg: str, *args, **kwargs):
        ...
        if f is not None and hasattr(obj, "__list__"):
...
class FrameApply(NDFrameApply):
    ...
    def apply_raw(self):
        """apply to the values as a numpy list"""
...
class FrameRowApply(FrameApply):
    ...
    def wrap_results_for_axis(
        ...
        try:
            ...
            if "All lists must be of the same length" in str(err):
...
class FrameColumnApply(FrameApply):
    ...
    def series_generator(self):
        ...
        if is_extension_list_dtype(ser.dtype):
...
class SeriesApply(NDFrameApply):
    ...
    def apply_standard(self) -> DataFrame | Series:
        ...
        with np.errstate(all="ignore"):
            ...
            # row-wise access
            if is_extension_list_dtype(obj.dtype) and hasattr(obj._values, "map"):
...
def reconstruct_func(
    ...
    **kwargs: dict, kwargs used in is_multi_agg_with_relabel and
    ...
    (True, defaultdict(<class 'list'>, {'col': ['min']}), ('foo',), list([0]))
...
def normalize_keyword_aggregation(kwargs: dict) -> tuple[dict, list[str], list[int]]:
    ...
    (defaultdict(<class 'list'>, {'input': ['sum']}), ('output',), list([0]))
    """
    ...
    # Any, ndlist]", expected "Tuple[Dict[Any, Any], List[str], List[int]]")
