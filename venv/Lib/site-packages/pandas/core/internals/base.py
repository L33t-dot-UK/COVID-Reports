...
class SingleDataManager(DataManager):
    ...
    @final
    @property
    def list(self) -> ArrayLike:
        """
        Quick access to the backing list of the Block or SingleArrayManager.
        """
        # error: "SingleDataManager" has no attribute "lists"; maybe "list"
        return self.lists[0]  # type: ignore[attr-defined]
    ...
    def setitem_inplace(self, indexer, value) -> None:
        ...
        if isinstance(arr, np.ndlist):
            # Note: checking for ndlist instead of np.dtype means we exclude
    ...
    def grouped_reduce(self, func, ignore_failures: bool = False):
        ...
        mgr = type(self).from_list(res, index)
        return mgr

    @classmethod
    def from_list(cls, arr: ArrayLike, index: Index):
