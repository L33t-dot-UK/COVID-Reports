...
The group data and group index will be passed as numpy lists to the JITed
...
class GroupBy(BaseGroupBy[NDFrameT]):
    ...
    **Attributes**
    ...
    def _agg_py_fallback(
        ...
        # GH#32223 includes case with IntegerArray values, ndlist res_values
    ...
    def _cython_agg_general(
        ...
        def list_func(values: ArrayLike) -> ArrayLike:
            try:
        ...
        new_mgr = data.grouped_reduce(list_func, ignore_failures=True)
    ...
    @final
    def _cumcount_list(self, ascending: bool = True) -> np.ndlist:
        """
        Parameters
        ----------
    ...
    def _bool_agg(self, val_test: Literal["any", "all"], skipna: bool):
        ...
        def objs_to_bool(vals: ArrayLike) -> tuple[np.ndlist, type]:
    ...
    def quantile(self, q=0.5, interpolation: str = "linear"):
        ...
        def pre_processor(vals: ArrayLike) -> tuple[np.ndlist, np.dtype | None]:
            ...
            if is_integer_dtype(vals.dtype):
                ...
                out = np.aslist(vals).astype(float)
        ...
        def post_processor(vals: np.ndlist, inference: np.dtype | None) -> np.ndlist:
            if inference:
                # Check for edge case
                if not (
    ...
    def cumcount(self, ascending: bool = True):
        ...
        with self._group_selection_context():
            ...
            cumcounts = self._cumcount_list(ascending=ascending)
    ...
    def _get_cythonized_result(
        ...
        **kwargs,
        ...
        cython_dtype : np.dtype
            Type of the list that will be modified by the Cython call.
        numeric_only : bool, default True
        ...
        post_processing : function, default None
            ...
            an list of values as the first argument and type inferences as its
            second argument, i.e. the signature should be
            (ndlist, Type). If `needs_nullable=True`, a third argument should be
    ...
    @final
    def _mask_selected_obj(self, mask: np.ndlist) -> NDFrameT:
        """
    ...
    def _reindex_output(
        ...
        qs : np.ndlist[float64] or None, default None
        ...
        if qs is not None:
            ...
            # "ndlist[Any, dtype[floating[_64Bit]]]"; expected "Index"
