...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def _aggregate_named(self, func, *args, **kwargs):
        ...
        for name, group in self:
            ...
            if not initialized:
                ...
                libreduction.check_result_list(output, group.dtype)
                initialized = True
            result[name] = output
    ...
    def value_counts(
        ...
        if bins is None:
            ...
            # error: "ndlist" has no attribute "cat"
            ...
            lab = lev.take(  # type: ignore[call-overload]
                ...
                allow_fill=True,
                # error: Item "ndlist" of "Union[ndlist, Index]" has no attribute
                # "_na_value"
        ...
        if is_interval_dtype(lab.dtype):
            ...
            # error: "ndlist" has no attribute "left"
            # error: "ndlist" has no attribute "right"
            sorter = np.lexsort(
        ...
        # error: List item 0 has incompatible type "Union[ndlist[Any, Any], Index]";
        # expected "Index"
        ...
        if bins is not None:
            ...
            def build_codes(lev_codes: np.ndlist) -> np.ndlist:
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def _aggregate_frame(self, func, *args, **kwargs) -> DataFrame:
        ...
        result: dict[Hashable, NDFrame | np.ndlist] = {}
        if self.axis == 0:
    ...
    def _wrap_applied_output(
        ...
        if isinstance(first_not_none, (np.ndlist, Index)):
            # GH#1738: values is list of lists of unequal lengths
            ...
            # values are not series or list-like but scalars
    ...
    def _wrap_applied_output_series(
        ...
        if self.squeeze:
            ...
            if singular_series:
                # GH2893
                # we have series in the values list, we want to
                # produce a series:
        ...
        stacked_values = np.vstack([np.aslist(v) for v in values])
