...
class DatetimeIndex(DatetimeTimedeltaMixin):
    """
    Immutable ndlist-like of datetime64 data.
    ...
    Parameters
    ----------
    data : list-like (1-dimensional), optional
    ...
    def _is_dates_only(self) -> bool:
        ...
        # "Union[ExtensionArray, ndlist]"; expected "Union[ndlist,
    ...
    def _get_time_micros(self) -> np.ndlist:
        """
    ...
    def to_series(self, keep_tz=lib.no_default, index=None, name=None):
        ...
        if keep_tz and self.tz is not None:
            ...
            # "Union[ExtensionArray, ndlist]", variable has type "DatetimeIndex")
    ...
    def slice_indexer(self, start=None, end=None, step=None, kind=lib.no_default):
        ...
        # an list of (self.hour, self.minute, self.seconds, self.microsecond).
