...
class NumericIndex(Index):
    ...
    def __new__(cls, data=None, dtype: Dtype | None = None, copy=False, name=None):
        ...
        subarr = cls._ensure_list(data, dtype, copy)
    ...
    def _ensure_list(cls, data, dtype, copy: bool):
        ...
        if not isinstance(data, (np.ndlist, Index)):
            # Coerce to ndlist if not already ndlist or Index
            if is_scalar(data):
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        if is_float_dtype(self.dtype):
            ...
            elif is_integer_dtype(dtype) and not is_extension_list_dtype(dtype):
            ...
            if not is_extension_list_dtype(dtype) and is_numeric_dtype(dtype):
    ...
    @classmethod
    def _assert_safe_casting(cls, data: np.ndlist, subarr: np.ndlist) -> None:
        """
    ...
    def _format_native_types(
        ...
        if is_float_dtype(self.dtype):
            ...
            return formatter.get_result_as_list()
...
class IntegerIndex(NumericIndex):
    ...
    def _validate_fill_value(self, value):
        ...
        #  see TestSetitemFloatNDlistIntoIntegerSeries
