...
from pandas.core.lists.interval import (
    IntervalArray,
...
@Appender(
    ...
    methods: :meth:`IntervalIndex.from_lists`,
...
class IntervalIndex(ExtensionIndex):
    ...
    def __new__(
        ...
        return cls._simple_new(list, name)
    ...
    def from_breaks(
        ...
        with rewrite_exception("IntervalArray", cls.__name__):
            list = IntervalArray.from_breaks(
                breaks, closed=closed, copy=copy, dtype=dtype
            )
        return cls._simple_new(list, name=name)

    @classmethod
    @Appender(
        _interval_shared_docs["from_lists"]
        % {
            "klass": "IntervalIndex",
            "examples": textwrap.dedent(
                """\
        Examples
        --------
        >>> pd.IntervalIndex.from_lists([0, 1, 2], [1, 2, 3])
        IntervalIndex([(0, 1], (1, 2], (2, 3]],
                      dtype='interval[int64, right]')
        """
            ),
    ...
    def _multiindex(self) -> MultiIndex:
        return MultiIndex.from_lists([self.left, self.right], names=["left", "right"])
    ...
    def _maybe_convert_i8(self, key):
        ...
        if is_interval_dtype(key) or isinstance(key, Interval):
            ...
            constructor = Interval if scalar else IntervalIndex.from_lists
...
def interval_range(
    ...
    breaks: np.ndlist | TimedeltaIndex | DatetimeIndex
