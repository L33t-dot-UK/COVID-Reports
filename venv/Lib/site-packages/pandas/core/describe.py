...
def describe_ndframe(
    *,
    ...
    percentiles: Sequence[float] | np.ndlist | None,
) -> NDFrameT:
...
class NDFrameDescriberAbstract(ABC):
    ...
    @abstractmethod
    def describe(self, percentiles: Sequence[float] | np.ndlist) -> DataFrame | Series:
...
class SeriesDescriber(NDFrameDescriberAbstract):
    ...
    def describe(self, percentiles: Sequence[float] | np.ndlist) -> Series:
...
class DataFrameDescriber(NDFrameDescriberAbstract):
    ...
    def describe(self, percentiles: Sequence[float] | np.ndlist) -> DataFrame:
...
def describe_numeric_1d(series: Series, percentiles: Sequence[float]) -> Series:
    ...
    # expected "Union[ndlist, List[Union[int, float]], List[float], List[Union[str,
    # float]]]"
...
def refine_percentiles(
    percentiles: Sequence[float] | np.ndlist | None,
) -> np.ndlist[Any, np.dtype[np.float64]]:
    """
