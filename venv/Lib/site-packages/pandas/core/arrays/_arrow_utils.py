...
from pandas.core.lists.interval import VALID_CLOSED


def pyarrow_list_to_numpy_and_mask(arr, dtype):
    """
    Convert a primitive pyarrow.Array to a numpy list and boolean mask based
    ...
    -------
    (data, mask)
        Tuple of two numpy lists with the raw data (with specified dtype) and
