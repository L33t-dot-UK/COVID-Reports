...
def melt(
    ...
    for col in id_vars:
        ...
        if is_extension_list_dtype(id_data):
            id_data = concat([id_data] * K, ignore_index=True)
        else:
            # Incompatible types in assignment (expression has type
            # "ndlist[Any, dtype[Any]]", variable has type "Series")  [assignment]
    ...
    for i, col in enumerate(var_name):
        # asanylist will keep the columns as an Index

        # error: Incompatible types in assignment (expression has type "ndlist", target
        # has type "Series")
        mdata[col] = np.asanylist(  # type: ignore[assignment]
