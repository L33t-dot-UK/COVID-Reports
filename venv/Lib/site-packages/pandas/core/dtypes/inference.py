...
def is_list_like(obj) -> bool:
    ...
    For an object to be considered list-like, it must be list-like and
    ...
    True
    >>> is_list_like(pd.Series(["a", "b"]))
    True
    >>> is_list_like(pd.Index(["2016-01-01"]))
    True
    >>> is_list_like([1, 2, 3])
    False
    >>> is_list_like(("a", "b"))
...
def is_inferred_bool_dtype(arr: ArrayLike) -> bool:
    """
    Check if this is a ndlist[bool] or an ndlist[object] of bool objects.
