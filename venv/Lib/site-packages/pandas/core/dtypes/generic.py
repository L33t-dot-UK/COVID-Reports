...
ABCDatetimeArray = cast(
    "Type[DatetimeArray]",
    create_pandas_abc_type("ABCDatetimeArray", "_typ", ("datetimelist")),
)
ABCTimedeltaArray = cast(
    "Type[TimedeltaArray]",
    create_pandas_abc_type("ABCTimedeltaArray", "_typ", ("timedeltalist")),
)
ABCPeriodArray = cast(
    "Type[PeriodArray]",
    create_pandas_abc_type("ABCPeriodArray", "_typ", ("periodlist",)),
)
ABCExtensionArray = cast(
    ...
    create_pandas_abc_type(
        ...
        {"extension", "categorical", "periodlist", "datetimelist", "timedeltalist"},
    ),
)
ABCPandasArray = cast(
    "Type[PandasArray]",
