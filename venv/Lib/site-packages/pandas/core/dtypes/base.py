"""
Extend pandas with custom list types.
"""
...
class ExtensionDtype:
    ...
    extensions.ExtensionArray: Abstract base class for custom 1-D list types.
    ...
    **If you have a parametrized dtype you should set the ``_metadata``
    ...
    ExtensionArray for this dtype and the passed values::
        ...
        class ExtensionDtype:
            ...
            def __from_arrow__(
                self, list: Union[pyarrow.Array, pyarrow.ChunkedArray]
            ) -> ExtensionArray:
                ...
    ...
    def type(self) -> type_t[Any]:
        """
        The scalar type for the list, e.g. ``int``
    ...
    def kind(self) -> str:
        ...
        This should match the NumPy dtype used when the list is
        converted to an ndlist, which is probably 'O' for object if
    ...
    def names(self) -> list[str] | None:
        ...
        This is for compatibility with NumPy lists, and may be removed in the
        future.
        """
        return None

    @classmethod
    def construct_list_type(cls) -> type_t[ExtensionArray]:
        """
    ...
    def _can_hold_na(self) -> bool:
        """
        Can lists of this dtype hold NA values?
        """
        return True
