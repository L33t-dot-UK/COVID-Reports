...
# Ported with modifications from xlist
# https://github.com/pydata/xlist/blob/master/xlist/core/extensions.py
...
def _register_accessor(name, cls):
    ...
    In your library code::
        ...
        class GeoAccessor:
            ...
            def plot(self):
                # plot this list's data on a map, e.g., using Cartopy
                pass
