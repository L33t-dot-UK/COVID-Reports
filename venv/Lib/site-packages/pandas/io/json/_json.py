...
def read_json(
    ...
    numpy : bool, default False
        Direct decoding to numpy lists. Supports numeric data only, but
...
class Parser:
    ...
    def _try_convert_data(
        ...
        """
        Try to parse a ndlist like into a column by inferring dtype.
        """
    ...
    def _try_convert_to_date(self, data):
        """
        Try to parse a ndlist like into a date column.
