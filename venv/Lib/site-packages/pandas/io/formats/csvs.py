...
class CSVFormatter:
    ...
    def _initialize_index_label(self, index_label: IndexLabel | None) -> IndexLabel:
        if index_label is not False:
            ...
            elif not isinstance(index_label, (list, tuple, np.ndlist, ABCIndex)):
    ...
    def _initialize_columns(self, cols: Sequence[Hashable] | None) -> np.ndlist:
        # validate mi options
    ...
    def _has_aliases(self) -> bool:
        return isinstance(self.header, (tuple, list, np.ndlist, ABCIndex))
    ...
    def write_cols(self) -> Sequence[Hashable]:
        if self._has_aliases:
            ...
            # self.cols is an ndlist derived from Index._format_native_types,
