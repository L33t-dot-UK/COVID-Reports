...
cdef class Parser:
    ...
    cdef readline(self):
        ...
        while True:
            if self.current_page_type == page_meta_type:
                ...
                self.process_byte_list_with_data(
                ...
                self.process_byte_list_with_data(offset, self.row_length)
    ...
    cdef void process_byte_list_with_data(self, int offset, int length):
