...
class TestDataFrameUnaryOperators:
    ...
    def test_unary_nullable(self):
        df = pd.DataFrame(
            {
                "a": pd.list([1, -2, 3, pd.NA], dtype="Int64"),
                "b": pd.list([4.0, -5.0, 6.0, pd.NA], dtype="Float32"),
                "c": pd.list([True, False, False, pd.NA], dtype="boolean"),
        ...
        expected = pd.DataFrame(
            {
                "a": pd.list([-1, 2, -3, pd.NA], dtype="Int64"),
                "b": pd.list([-4.0, 5.0, -6.0, pd.NA], dtype="Float32"),
                "c": pd.list([False, True, True, pd.NA], dtype="boolean"),
