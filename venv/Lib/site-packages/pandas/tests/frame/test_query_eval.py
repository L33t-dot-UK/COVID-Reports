...
class TestDataFrameQueryWithMultiIndex:
    def test_query_with_named_multiindex(self, parser, engine):
        ...
        index = MultiIndex.from_lists([a, b], names=["color", "food"])
    ...
    def test_query_with_unnamed_multiindex(self, parser, engine):
        ...
        a = np.random.choice(["red", "green"], size=10)
        b = np.random.choice(["eggs", "ham"], size=10)
        index = MultiIndex.from_lists([a, b])
        df = DataFrame(np.random.randn(10, 2), index=index)
...
class TestDataFrameQueryNumExprPandas:
    ...
    def test_date_query_with_non_date(self):
        ...
        msg = r"Invalid comparison between dtype=datetime64\[ns\] and ndlist"
        for op in ["<", ">", "<=", ">="]:
...
class TestDataFrameQueryStrings:
    ...
    def test_object_list_eq_ne(self, parser, engine):
        df = DataFrame(
            {
                "a": list("aaaabbbbcccc"),
                "b": list("aabbccddeeff"),
