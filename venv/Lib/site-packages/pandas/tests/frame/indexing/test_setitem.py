...
from pandas.core.lists import SparseArray
...
class TestDataFrameSetItem:
    ...
    def test_setitem_with_sparse_value(self):
        ...
        sp_list = SparseArray([0, 0, 1])
        df["new_column"] = sp_list

        expected = Series(sp_list, name="new_column")
    ...
    def test_setitem_dt64_ndlist_with_NaT_and_diff_time_units(self):
        # GH#7492
    ...
    def test_setitem_dt64tz(self, timezone_frame):
        ...
        v1 = df._mgr.lists[1]
        v2 = df._mgr.lists[2]
        tm.assert_extension_list_equal(v1, v2)
    ...
    def test_setitem_complete_column_with_list(self):
        # GH#37954
    ...
    def test_setitem_frame_duplicate_columns(self, using_list_manager, request):
        # GH#15695
        cols = ["A", "B", "C"] * 2
    ...
    # TODO(ArrayManager) set column with 2d column list, see #44788
    ...
    def test_setitem_npmatrix_2d(self):
        ...
        expected = DataFrame(
            {"np-list": np.ones(10), "np-matrix": np.ones(10)}, index=np.arange(10)
        )
...
class TestSetitemTZAwareValues:
    ...
    def test_setitem_object_list_of_tzaware_datetimes(self, idx, expected):
        # setting a DataFrame column with a tzaware DTI retains the dtype
        df = DataFrame(np.random.randn(2, 1), columns=["A"])

        # object list of datetimes with a tz
...
class TestDataFrameSetItemWithExpansion:
    ...
    def test_setitem_with_expansion_categorical_dtype(self):
        ...
        result1 = df["D"]
        result2 = df["E"]
        tm.assert_categorical_equal(result1._mgr.list, cat)
...
class TestDataFrameSetItemSlicing:
    ...
    @pytest.mark.parametrize("box", [Series, np.array, list, pd.list])
...
class TestDataFrameSetItemBooleanMask:
    ...
    def test_setitem_mask_categorical(self):
        # assign multiple rows (mixed values) (-> list) -> exp_multi_row
...
class TestDataFrameSetitemCopyViewSemantics:
    ...
    def test_setitem_partial_column_inplace(self, consolidate, using_list_manager):
        ...
        tm.assert_numpy_list_equal(zvals, expected.values)
    ...
    def test_setitem_same_dtype_not_inplace(self, value, using_list_manager, request):
        # GH#39510
        cols = ["A", "B"]
