...
class TestTZConvert:
    ...
    def test_tz_convert_and_localize(self, fn):
        ...
        for idx in [l0, l1]:
            ...
            # MultiIndex
            # GH7846
            df2 = DataFrame(np.ones(5), MultiIndex.from_lists([l0, l1]))
            ...
            df4 = DataFrame(np.ones(5), MultiIndex.from_lists([int_idx, l0]))
        ...
        # Not DatetimeIndex / PeriodIndex
        with pytest.raises(TypeError, match="DatetimeIndex"):
            df = DataFrame(np.ones(5), MultiIndex.from_lists([int_idx, l0]))
