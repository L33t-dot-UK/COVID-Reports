...
class TestToTimestamp:
    def test_to_timestamp(self, frame_or_series):
        ...
        tm.assert_numpy_list_equal(result.values, obj.values)
    ...
    def test_to_timestamp_columns(self):
        ...
        tm.assert_numpy_list_equal(result.values, df.values)
        ...
        tm.assert_numpy_list_equal(result1.columns.asi8, expected.asi8)
        tm.assert_numpy_list_equal(result2.columns.asi8, expected.asi8)
