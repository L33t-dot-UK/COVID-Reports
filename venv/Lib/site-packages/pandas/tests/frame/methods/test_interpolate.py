...
class TestDataFrameInterpolate:
    def test_interpolate_inplace(self, frame_or_series, using_list_manager, request):
        # GH#44749
        if using_list_manager and frame_or_series is DataFrame:
    ...
    def test_interp_fillna_methods(self, request, axis, method, using_list_manager):
        # GH 12918
        if using_list_manager and (axis == 1 or axis == "columns"):
