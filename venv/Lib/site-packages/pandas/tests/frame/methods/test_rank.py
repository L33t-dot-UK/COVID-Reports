...
class TestRank:
    ...
    def test_rank_na_option(self, float_frame):
        ...
        tm.assert_numpy_list_equal(ranks0.values, exp0)
        tm.assert_numpy_list_equal(ranks1.values, exp1)
    ...
    def test_rank_inf_and_nan(self, contents, dtype, frame_or_series):
        ...
        # Shuffle the testing list and expected results in the same way
