...
class DotSharedTests:
    ...
    def test_dot_2d_ndlist(self, obj, other, expected):
        # Check ndlist argument; in this case we get matching values,
        #  but index/columns may not match
        result = obj.dot(other.values)
        assert np.all(result == expected.values)

    def test_dot_1d_ndlist(self, obj, expected):
        # can pass correct-length list
