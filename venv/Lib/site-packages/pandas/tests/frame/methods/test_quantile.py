...
class TestDataFrameQuantile:
    @pytest.mark.parametrize(
        ...
        [
            [
                DataFrame(
                    {
                        0: Series(pd.lists.SparseArray([1, 2])),
                        1: Series(pd.lists.SparseArray([3, 4])),
                    }
                ),
    ...
    def test_quantile_item_cache(self, using_list_manager):
...
class TestQuantileExtensionDtype:
    ...
    @pytest.fixture(
        params=[
            ...
            pd.list(np.arange(9), dtype="Int64"),
            pd.list(np.arange(9), dtype="Float64"),
        ],
    ...
    def test_quantile_ea_all_na(
        self, obj, index, frame_or_series, using_list_manager, request
    ):
        if (
            using_list_manager
