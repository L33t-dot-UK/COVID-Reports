...
class GroupVarTestMixin:
    def test_group_var_generic_1d(self):
        ...
        tm.assert_numpy_list_equal(counts, expected_counts)
...
def test_group_ohlc(dtype):
    ...
    tm.assert_numpy_list_equal(counts, np.array([6, 6, 8], dtype=np.int64))
...
def _check_cython_group_transform_cumulative(pd_op, np_op, dtype):
    ...
    tm.assert_numpy_list_equal(np_op(data), answer[:, 0], check_dtype=False)
...
def test_cython_group_transform_algos():
    ...
    tm.assert_numpy_list_equal(actual[:, 0], expected)
    ...
    tm.assert_numpy_list_equal(actual[:, 0].view("m8[ns]"), expected)
...
def test_cython_group_mean_datetimelike():
    ...
    tm.assert_numpy_list_equal(actual[:, 0], np.array([3], dtype="float64"))
