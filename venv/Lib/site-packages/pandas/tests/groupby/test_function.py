...
def test_nlargest():
    ...
    e = Series(
        [7, 5, 3, 10, 9, 6],
        index=MultiIndex.from_lists([list("aaabbb"), [3, 2, 1, 9, 5, 8]]),
    )
    ...
    e = Series(
        [3, 2, 1, 3, 3, 2],
        index=MultiIndex.from_lists([list("aaabbb"), [2, 3, 1, 6, 5, 7]]),
    )
...
def test_nsmallest():
    ...
    e = Series(
        [1, 2, 3, 0, 4, 6],
        index=MultiIndex.from_lists([list("aaabbb"), [0, 4, 1, 6, 7, 8]]),
    )
    tm.assert_series_equal(r, e)
    ...
    e = Series(
        [0, 1, 1, 0, 1, 2],
        index=MultiIndex.from_lists([list("aaabbb"), [4, 1, 0, 9, 8, 7]]),
    )
...
def test_nlargest_and_smallest_noop(data, groups, method):
    ...
    expected = Series(data, index=MultiIndex.from_lists([groups, ser.index]), name="a")
    tm.assert_series_equal(result, expected)
