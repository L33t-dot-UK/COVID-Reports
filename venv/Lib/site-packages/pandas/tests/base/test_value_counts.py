...
def test_value_counts_bins(index_or_series):
    ...
    if isinstance(s1, Index):
        ...
        tm.assert_numpy_list_equal(s1.unique(), exp)
    ...
    if isinstance(s, Index):
        ...
        tm.assert_numpy_list_equal(s.unique(), np.array([]), check_dtype=False)
...
def test_value_counts_datetime64(index_or_series):
    ...
    if isinstance(s, Index):
        ...
        tm.assert_numpy_list_equal(s.unique(), expected)
    ...
    # numpy_list_equal cannot compare pd.NaT
    if isinstance(s, Index):
        exp_idx = DatetimeIndex(expected.tolist() + [pd.NaT])
        tm.assert_index_equal(unique, exp_idx)
    else:
        tm.assert_numpy_list_equal(unique[:3], expected)
    ...
    if isinstance(td, Index):
        ...
        tm.assert_numpy_list_equal(td.unique(), expected.values)
