...
class TestTextReader:
    ...
    def test_skip_bad_lines(self, capsys):
        ...
        assert_list_dicts_equal(result, expected)
    ...
    def test_header_not_enough_lines(self):
        ...
        assert_list_dicts_equal(recs, expected)
...
def assert_list_dicts_equal(left, right):
    for k, v in left.items():
        tm.assert_numpy_list_equal(np.aslist(v), np.aslist(right[k]))
