...
def test_background_gradient_gmap_list(styler_blank, axis, gmap, expected):
    # tests when gmap is given as a sequence and converted to ndlist
...
def test_background_gradient_gmap_list_raises(gmap, axis):
    # test when gmap as converted ndlist is bad shape
