...
class TestDataFrameFormatting:
    ...
    def test_to_string_truncate_multilevel(self):
        ...
        df = DataFrame(index=lists, columns=lists)
    ...
    def test_wide_repr(self):
        with option_context(
            ...
            df = DataFrame(tm.rands_list(25, size=(10, max_cols - 1)))
    ...
    def test_wide_repr_multiindex(self):
        with option_context("mode.sim_interactive", True, "display.max_columns", 20):
            midx = MultiIndex.from_lists(tm.rands_list(5, size=(2, 10)))
            max_cols = get_option("display.max_columns")
            df = DataFrame(tm.rands_list(25, size=(10, max_cols - 1)), index=midx)
    ...
    def test_wide_repr_multiindex_cols(self):
        with option_context("mode.sim_interactive", True, "display.max_columns", 20):
            max_cols = get_option("display.max_columns")
            midx = MultiIndex.from_lists(tm.rands_list(5, size=(2, 10)))
            mcols = MultiIndex.from_lists(tm.rands_list(3, size=(2, max_cols - 1)))
            df = DataFrame(
                tm.rands_list(25, (10, max_cols - 1)), index=midx, columns=mcols
            )
            df.index.names = ["Level 0", "Level 1"]
            set_option("display.expand_frame_repr", False)
            rep_str = repr(df)
...
"""
    ...
    def test_repr_html_wide(self):
        ...
        wide_df = DataFrame(tm.rands_list(25, size=(10, max_cols + 1)))
        with option_context("display.max_rows", 60, "display.max_columns", 20):
    ...
    def test_repr_html_wide_multiindex_cols(self):
        ...
        df = DataFrame(tm.rands_list(25, size=(10, len(mcols))), columns=mcols)
