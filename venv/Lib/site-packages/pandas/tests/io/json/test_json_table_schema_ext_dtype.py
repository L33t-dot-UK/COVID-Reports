...
from pandas.core.lists.integer import Int64Dtype
...
class TestBuildSchema:
    def setup_method(self, method):
        ...
        self.sa = list(["pandas"], dtype="string")
        self.ia = list([10], dtype="Int64")
        self.df = DataFrame(
            {
                "A": self.da,
                "B": self.dc,
...
class TestTableSchemaType:
    ...
    def test_as_json_table_type_ext_date_list_dtype(self, date_data):
    ...
    def test_as_json_table_type_ext_decimal_list_dtype(self, decimal_data):
    ...
    @pytest.mark.parametrize(
        "string_data",
        [
            list(["pandas"], dtype="string"),
            Series(list(["pandas"], dtype="string")),
        ],
    )
    def test_as_json_table_type_ext_string_list_dtype(self, string_data):
    ...
    @pytest.mark.parametrize(
        ...
        [
            list([10], dtype="Int64"),
            Series(list([10], dtype="Int64")),
        ],
    )
    def test_as_json_table_type_ext_integer_list_dtype(self, integer_data):
