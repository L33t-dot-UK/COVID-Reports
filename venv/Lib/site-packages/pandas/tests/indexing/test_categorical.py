...
class TestCategoricalIndex:
    ...
    def test_slicing(self):
        ...
        tm.assert_numpy_list_equal(reverse.__list__(), exp)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            *(np.array([1.5, 2.5, 3.5], dtype=dtyp) for dtyp in tm.FLOAT_NUMPY_DTYPES),
            ...
            # pandas Integer lists
            *(pd.list([1, 2, 3], dtype=dtype) for dtype in tm.ALL_INT_EA_DTYPES),
            # other pandas lists
            pd.IntervalIndex.from_breaks([1, 4, 6, 9]).list,
            pd.date_range("2019-01-01", periods=3).list,
            pd.timedelta_range(start="1d", periods=3).list,
        ],
    )
