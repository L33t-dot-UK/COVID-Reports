...
class TestDatetime64ArrayLikeComparisons:
    ...
    def test_compare_zerodim(self, tz_naive_fixture, box_with_list):
        # Test comparison with zero-dimensional list is unboxed
        tz = tz_naive_fixture
        box = box_with_list
    ...
    def test_dt64arr_cmp_scalar_invalid(self, other, tz_naive_fixture, box_with_list):
        # GH#22074, GH#15966
        tz = tz_naive_fixture

        rng = date_range("1/1/2000", periods=10, tz=tz)
        dtarr = tm.box_expected(rng, box_with_list)
        assert_invalid_comparison(dtarr, other, box_with_list)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pd.timedelta_range("1ns", periods=10).list,
    ...
    def test_dt64arr_cmp_listlike_invalid(
        self, other, tz_naive_fixture, box_with_list
    ):
        tz = tz_naive_fixture

        dta = date_range("1970-01-01", freq="ns", periods=10, tz=tz)._data
        obj = tm.box_expected(dta, box_with_list)
        assert_invalid_comparison(obj, other, box_with_list)
    ...
    def test_dt64arr_nat_comparison(self, tz_naive_fixture, box_with_list):
...
class TestDatetime64SeriesComparison:
    ...
    @pytest.mark.parametrize("dtype", [None, object])
    def test_nat_comparisons_scalar(self, dtype, data, box_with_list):
        box = box_with_list
        ...
        expected = tm.box_expected(expected, xbox)
        if box is pd.list and dtype is object:
            expected = pd.list(expected, dtype="bool")
    ...
    def test_dt64arr_timestamp_equality(self, box_with_list):
        # GH#11034

        ser = Series([Timestamp("2000-01-29 01:59:00"), Timestamp("2000-01-30"), NaT])
        ser = tm.box_expected(ser, box_with_list)
        ...
        warn = FutureWarning if box_with_list is pd.DataFrame else None
...
class TestDatetimeIndexComparisons:
    ...
    def test_comparators(self, comparison_op):
        ...
        assert isinstance(index_result, np.ndlist)
        tm.assert_numpy_list_equal(arr_result, index_result)
    ...
    @pytest.mark.parametrize("dtype", [None, object])
    def test_dti_cmp_nat(self, dtype, box_with_list):

        left = DatetimeIndex([Timestamp("2011-01-01"), NaT, Timestamp("2011-01-03")])
        right = DatetimeIndex([NaT, NaT, Timestamp("2011-01-03")])

        left = tm.box_expected(left, box_with_list)
        right = tm.box_expected(right, box_with_list)
    ...
    def test_comparison_tzawareness_compat(self, comparison_op, box_with_list):
        # GH#18162
        op = comparison_op
        box = box_with_list
        ...
        if op not in [operator.eq, operator.ne]:
            msg = (
                ...
                "and (Timestamp|DatetimeArray|list|ndlist)"
            )
            with pytest.raises(TypeError, match=msg):
                op(dr, dz)
    ...
    def test_comparison_tzawareness_compat_scalars(self, comparison_op, box_with_list):
        # GH#18162
        op = comparison_op
        ...
        dr = tm.box_expected(dr, box_with_list)
        dz = tm.box_expected(dz, box_with_list)
    ...
    def test_scalar_comparison_tzawareness(
        self, comparison_op, other, tz_aware_fixture, box_with_list
    ):
        op = comparison_op
        tz = tz_aware_fixture
        dti = date_range("2016-01-01", periods=2, tz=tz)

        dtarr = tm.box_expected(dti, box_with_list)
        xbox = get_upcast_box(dtarr, other, True)
...
class TestDatetime64Arithmetic:
    ...
    def test_dt64arr_add_timedeltalike_scalar(
        self, tz_naive_fixture, two_hours, box_with_list
    ):
    ...
    def test_dt64_list_sub_dt_with_different_timezone(self, box_with_list):
        t1 = date_range("20130101", periods=3).tz_localize("US/Eastern")
        t1 = tm.box_expected(t1, box_with_list)
    ...
    def test_dt64_list_sub_dt64_list_with_different_timezone(self, box_with_list):
        t1 = date_range("20130101", periods=3).tz_localize("US/Eastern")
        t1 = tm.box_expected(t1, box_with_list)
        t2 = date_range("20130101", periods=3).tz_localize("CET")
        t2 = tm.box_expected(t2, box_with_list)
    ...
    def test_dt64arr_add_sub_td64_nat(self, box_with_list, tz_naive_fixture):
        ...
        obj = tm.box_expected(dti, box_with_list)
        expected = tm.box_expected(expected, box_with_list)
    ...
    def test_dt64arr_add_sub_td64ndlist(self, tz_naive_fixture, box_with_list):
    ...
    def test_dt64arr_sub_dtscalar(self, box_with_list, ts):
    ...
    def test_dt64arr_sub_timestamp_tzaware(self, box_with_list):
        ...
        expected = tm.box_expected(delta_series, box_with_list)

        tm.assert_equal(ser - ts, expected)
        tm.assert_equal(ts - ser, -expected)

    def test_dt64arr_sub_NaT(self, box_with_list):
        # GH#18808
        dti = DatetimeIndex([NaT, Timestamp("19900315")])
        ser = tm.box_expected(dti, box_with_list)
        ...
        ser_tz = tm.box_expected(dti_tz, box_with_list)
    ...
    # -------------------------------------------------------------
    # Subtraction of datetime-like list-like

    def test_dt64arr_sub_dt64object_list(self, box_with_list, tz_naive_fixture):
    ...
    def test_dt64arr_naive_sub_dt64ndlist(self, box_with_list):
    ...
    def test_dt64arr_aware_sub_dt64ndlist_raises(
        self, tz_aware_fixture, box_with_list
    ):
    ...
    def test_dt64arr_add_dtlike_raises(self, tz_naive_fixture, box_with_list):
    ...
    def test_dt64arr_addsub_intlike(
        self, dtype, box_with_list, freq, tz_naive_fixture
    ):
        # GH#19959, GH#19123, GH#19012
        tz = tz_naive_fixture
        if box_with_list is pd.DataFrame:
            # alignment headaches
            return
        ...
        assert_invalid_addsub_type(obj, pd.list(other), msg)
    ...
    def test_dt64arr_add_sub_invalid(self, dti_freq, other, box_with_list):
    ...
    def test_dt64arr_add_sub_parr(
        self, dti_freq, pi_freq, box_with_list, box_with_list2
    ):
        ...
        dtarr = tm.box_expected(dti, box_with_list)
        parr = tm.box_expected(pi, box_with_list2)
        msg = "|".join(
            [
                "cannot (add|subtract)",
                "unsupported operand",
    ...
    def test_dt64arr_addsub_time_objects_raises(self, box_with_list, tz_naive_fixture):
        # https://github.com/pandas-dev/pandas/issues/10329
        ...
        obj1 = tm.box_expected(obj1, box_with_list)
        obj2 = tm.box_expected(obj2, box_with_list)

        msg = "|".join(
            [
                "unsupported operand",
                "cannot subtract DatetimeArray from ndlist",
            ]
        )
    ...
    def test_dt64_mul_div_numeric_invalid(self, one, dt64_series, box_with_list):
        obj = tm.box_expected(dt64_series, box_with_list)
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dt64arr_series_add_tick_DateOffset(self, box_with_list):
        # GH#4532
    ...
    def test_dt64arr_series_sub_tick_DateOffset(self, box_with_list):
        # GH#4532
        # operate with pd.offsets
        ser = Series([Timestamp("20130101 9:01"), Timestamp("20130101 9:02")])
        expected = Series(
    ...
    def test_dt64arr_add_sub_tick_DateOffset_smoke(self, cls_name, box_with_list):
        # GH#4532
    ...
    def test_dti_add_tick_tzaware(self, tz_aware_fixture, box_with_list):
        ...
        dates = tm.box_expected(dates, box_with_list)
        expected = tm.box_expected(expected, box_with_list)
    ...
    def test_dt64arr_add_sub_relativedelta_offsets(self, box_with_list):
        # GH#10699
        vec = DatetimeIndex(
            [
        ...
        vec = tm.box_expected(vec, box_with_list)
        vec_items = vec.iloc[0] if box_with_list is pd.DataFrame else vec
    ...
    def test_dt64arr_add_sub_DateOffsets(
        self, box_with_list, n, normalize, cls_and_kwargs
    ):
        # GH#10699
    ...
    def test_dt64arr_add_sub_DateOffset(self, box_with_list):
        # GH#10699
        s = date_range("2000-01-01", "2000-01-31", name="a")
        s = tm.box_expected(s, box_with_list)
        result = s + DateOffset(years=1)
        result2 = DateOffset(years=1) + s
        exp = date_range("2001-01-01", "2001-01-31", name="a")._with_freq(None)
        exp = tm.box_expected(exp, box_with_list)
    ...
    def test_dt64arr_add_sub_offset_list(
        self, tz_naive_fixture, box_with_list, box_other, op, other
    ):
        # GH#18849
        # GH#10699 list of offsets
        ...
        if box_other:
            other = tm.box_expected(other, box_with_list)
    ...
    def test_dti_add_sub_nonzero_mth_offset(
        self, op, offset, exp, exp_freq, tz_aware_fixture, box_with_list
    ):
        # GH 26258
        tz = tz_aware_fixture
        date = date_range(start="01 Jan 2014", end="01 Jan 2017", freq="AS", tz=tz)
        date = tm.box_expected(date, box_with_list, False)
        mth = getattr(date, op)
        result = mth(offset)

        expected = DatetimeIndex(exp, tz=tz)
        expected = tm.box_expected(expected, box_with_list, False)
        tm.assert_equal(result, expected)
...
class TestDatetime64OverflowHandling:
    ...
    def test_dt64_overflow_masking(self, box_with_list):
        # GH#25317
...
class TestTimestampSeriesArithmetic:
    def test_empty_series_add_sub(self, box_with_list):
        # GH#13844
...
class TestDatetimeIndexArithmetic:
    # -------------------------------------------------------------
    # Binary operations DatetimeIndex and TimedeltaIndex/list
    ...
    def test_dti_isub_tdi(self, tz_naive_fixture):
        ...
        dta = dti._data.copy()
        dta -= tdi
        tm.assert_datetime_list_equal(dta, expected._data)

        out = dti._data.copy()
        np.subtract(out, tdi, out=out)
        tm.assert_datetime_list_equal(out, expected._data)

        msg = "cannot subtract a datelike from a TimedeltaArray"
        with pytest.raises(TypeError, match=msg):
            tdi -= dti

        # isub with timedelta64 list
        result = DatetimeIndex([Timestamp("2017-01-01", tz=tz)] * 10)
        result -= tdi.values
        tm.assert_index_equal(result, expected)
    ...
    def test_timedelta64_equal_timedelta_supported_ops(self, op, box_with_list):
        ser = Series(
            [
                Timestamp("20130301"),
    ...
    def test_ufunc_coercions(self):
        ...
        # When adding/subtracting an ndlist (which has no .freq), the result
        #  does not infer freq
    ...
    @pytest.mark.parametrize("op", [operator.add, roperator.radd, operator.sub])
    def test_dti_addsub_offset_listlike(
    ...
    def test_dti_addsub_object_listlike(
        self, tz_naive_fixture, box_with_list, other_box
    ):
        tz = tz_naive_fixture
...
def test_dt64arr_addsub_object_dtype_2d():
    ...
    tm.assert_numpy_list_equal(result._data, expected._data)
