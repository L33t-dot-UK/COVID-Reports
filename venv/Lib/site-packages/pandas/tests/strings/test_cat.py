...
def test_str_cat(index_or_series):
    box = index_or_series
    # test_cat above tests "str_cat" from ndlist;
    # here testing "str.cat" from Series/Index to ndlist/list
    ...
    rgx = r"If `others` contains lists or lists \(or other list-likes.*"
    z = Series(["1", "2", "3"])
...
def test_str_cat_mixed_inputs(index_or_series):
    ...
    # Series/Index with two-dimensional ndlist
    ...
    # Series/Index with mixed list of Series/list
