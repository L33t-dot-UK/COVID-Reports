...
def test_string_list(nullable_string_dtype, any_string_method):
    ...
    if isinstance(expected, Series):
        if expected.dtype == "object" and lib.is_string_list(
            expected.dropna().values,
        ):
            assert result.dtype == nullable_string_dtype
            result = result.astype(object)

        elif expected.dtype == "object" and lib.is_bool_list(
...
def test_string_list_numeric_integer_list(nullable_string_dtype, method, expected):
...
def test_string_list_boolean_list(nullable_string_dtype, method, expected):
...
def test_string_list_extract(nullable_string_dtype):
