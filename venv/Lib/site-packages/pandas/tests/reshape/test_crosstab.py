...
class TestCrosstab:
    ...
    def test_crosstab_ndlist(self, box):
        # GH 44076
    ...
    def test_crosstab_normalize_lists(self):
        # GH#12578
        df = DataFrame(
            {"a": [1, 2, 2, 2, 2], "b": [3, 3, 4, 4, 4], "c": [1, 1, np.nan, 1, 1]}
        )
    ...
    def test_crosstab_with_empties(self, using_list_manager):
    ...
    def test_crosstab_tuple_name(self, names):
        ...
        mi = MultiIndex.from_lists([range(3), range(1, 4)], names=names)
