...
class BaseArithmeticOpsTests(BaseOpsUtil):
    ...
    * divmod_exc = TypeError
    ...
    def test_arith_series_with_list(self, data, all_arithmetic_operators):
        ...
        ser = pd.Series(data)
        self.check_opname(
            ser, op_name, pd.Series([ser.iloc[0]] * len(ser)), exc=self.series_list_exc
        )
    ...
    def test_divmod_series_list(self, data, data_for_twos):
        ser = pd.Series(data)
...
class BaseUnaryOpsTests(BaseOpsUtil):
    ...
    def test_unary_ufunc_dunder_equivalence(self, data, ufunc):
        ...
        try:
            ...
            alt = ufunc(data)
            self.assert_extension_list_equal(result, alt)
