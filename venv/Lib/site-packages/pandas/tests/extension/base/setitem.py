...
class BaseSetitemTests(BaseExtensionTests):
    ...
    def test_setitem_sequence_mismatched_length_raises(self, data, as_list):
        ser = pd.Series(data)
        original = ser.copy()
        value = [data[0]]
        if as_list:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pd.list([True, True, True, pd.NA, pd.NA], dtype="boolean"),
        ],
        ids=["numpy-list", "boolean-list", "boolean-list-na"],
    )
    ...
    def test_setitem_mask_boolean_list_with_na(self, data, box_in_series):
    ...
    def test_setitem_slice_list(self, data):
        arr = data[:5].copy()
        arr[:5] = data[-5:]
        self.assert_extension_list_equal(arr, data[-5:])
    ...
    def test_setitem_frame_2d_values(self, data, request):
        ...
        # Avoiding using_list_manager fixture
        #  https://github.com/pandas-dev/pandas/pull/44514#discussion_r754002410
        using_list_manager = isinstance(df._mgr, pd.core.internals.ArrayManager)
