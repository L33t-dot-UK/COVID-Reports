...
class BaseInterfaceTests(BaseExtensionTests):
    ...
    def test_is_extension_list_dtype(self, data):
        assert is_extension_list_dtype(data)
        assert is_extension_list_dtype(data.dtype)
        assert is_extension_list_dtype(pd.Series(data))
    ...
    def test_isna_extension_list(self, data_missing):
