...
class BaseMethodsTests(BaseExtensionTests):
    ...
    def test_argsort_missing_list(self, data_missing_for_sorting):
    ...
    def test_argmin_argmax_empty_list(self, method, data):
        # GH 24382
    ...
    def test_factorize_equivalence(self, data_for_grouping, na_sentinel):
        ...
        tm.assert_numpy_list_equal(codes_1, codes_2)
        self.assert_extension_list_equal(uniques_1, uniques_2)
    ...
    def test_shift_non_empty_list(self, data, periods, indices):
    ...
    def test_shift_empty_list(self, data, periods):
        # https://github.com/pandas-dev/pandas/issues/23911
        empty = data[:0]
