...
class BaseReshapingTests(BaseExtensionTests):
    ...
    def test_merge_on_extension_list(self, data):
        # GH 23020
        a, b = data[:2]
    ...
    def test_merge_on_extension_list_duplicates(self, data):
        # GH 23020
        a, b = data[:2]
    ...
    def test_unstack(self, data, index, obj):
        ...
        for level in combinations:
            ...
            assert all(
                isinstance(result[col].list, type(data)) for col in result.columns
            )
