...
class TestHashTable:
    ...
    def test_lookup(self, table_type, dtype, writable):
        ...
        tm.assert_numpy_list_equal(result.astype(np.int64), expected.astype(np.int64))
    ...
    def test_unique(self, table_type, dtype, writable):
        ...
        tm.assert_numpy_list_equal(unique, expected)
...
def test_get_labels_groupby_for_Int64(writable):
    ...
    tm.assert_numpy_list_equal(arr, expected_arr)
    tm.assert_numpy_list_equal(unique, expected_unique)
...
class TestHelpFunctions:
    def test_value_count(self, dtype, writable):
        ...
        tm.assert_numpy_list_equal(np.sort(keys), expected)
    ...
    def test_value_count_stable(self, dtype, writable):
        ...
        values.flags.writeable = writable
        keys, counts = ht.value_count(values, False)
        tm.assert_numpy_list_equal(keys, values)
