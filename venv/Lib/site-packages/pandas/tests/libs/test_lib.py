...
class TestMisc:
    def test_max_len_string_list(self):

        arr = a = np.array(["foo", "b", np.nan], dtype="object")
        assert libwriters.max_len_string_list(arr) == 3
        ...
        with pytest.raises(TypeError, match=msg):
            libwriters.max_len_string_list(arr.astype("U"))
    ...
    def test_fast_unique_multiple_list_gen_sort(self):
        ...
        tm.assert_numpy_list_equal(np.array(out), expected)
...
class TestIndexing:
    def test_maybe_indices_to_slice_left_edge(self):
        ...
        tm.assert_numpy_list_equal(target[indices], target[maybe_slice])
        ...
        for case in [[2, 1, 2, 0], [2, 2, 1, 0], [0, 1, 2, 1], [-2, 0, 2], [2, 0, -2]]:
            ...
            tm.assert_numpy_list_equal(maybe_slice, indices)
            tm.assert_numpy_list_equal(target[indices], target[maybe_slice])
