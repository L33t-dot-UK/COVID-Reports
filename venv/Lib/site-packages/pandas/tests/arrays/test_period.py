...
def test_asi8():
    result = period_list(["2000", "2001", None], freq="D").asi8
...
def test_fillna_raises():
    arr = period_list(["2000", "2001", "2002"], freq="D")
...
def test_setitem(key, value, expected):
    ...
    arr[key] = value
    tm.assert_period_list_equal(arr, expected)
...
def test_setitem_raises_incompatible_freq():
    ...
    other = period_list(["2000", "2001"], freq="A")
    with pytest.raises(IncompatibleFrequency, match="freq"):
        arr[[0, 1]] = other
...
@pytest.mark.parametrize(
    "other",
    [pd.Period("2000", freq="H"), period_list(["2000", "2001", "2000"], freq="H")],
)
def test_where_different_freq_raises(other):
    ser = pd.Series(period_list(["2000", "2001", "2002"], freq="D"))
...
def test_repr_large():
    arr = period_list(["2000", "2001"] * 500, freq="D")
    result = str(arr)
    expected = (
        "<PeriodArray>\n"
