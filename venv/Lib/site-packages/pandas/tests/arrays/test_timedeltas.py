    ...
    def test_searchsorted_invalid_types(self, other, index):
        ...
        msg = "|".join(
            [
                ...
                "value should be a 'Timedelta', 'NaT', or list of those. Got",
            ]
        )
...
class TestUnaryOps:
    def test_abs(self):
        ...
        result = abs(arr)
        tm.assert_timedelta_list_equal(result, expected)

        result2 = np.abs(arr)
        tm.assert_timedelta_list_equal(result2, expected)
    ...
    def test_pos(self):
        ...
        result = +arr
        tm.assert_timedelta_list_equal(result, arr)
        assert not tm.shares_memory(result, arr)

        result2 = np.positive(arr)
        tm.assert_timedelta_list_equal(result2, arr)
