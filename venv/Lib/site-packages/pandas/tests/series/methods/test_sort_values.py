...
class TestSeriesSortValues:
    def test_sort_values(self, datetime_series):
        ...
        tm.assert_numpy_list_equal(result[:-5].values, np.sort(vals[5:]))
        ...
        msg = (
            "This Series is a view of some other list, to sort in-place "
    ...
    def test_sort_values_categorical(self):
        ...
        tm.assert_numpy_list_equal(res.__list__(), exp)
        ...
        exp = np.array(["d", "c", "b", "a"], dtype=np.object_)
        tm.assert_numpy_list_equal(res["sort"].values.__list__(), exp)
