...
class TestSeriesLogicalOps:
    ...
    def test_bool_operators_with_nas(self, bool_op):
        # boolean &, |, ^ should work with object lists and propagate NAs
    ...
    def test_logical_operators_int_dtype_with_float(self):
        ...
        msg = "Cannot perform.+with a dtyped.+list and scalar of type"
    ...
    def test_logical_operators_int_dtype_with_str(self):
        s_1111 = Series([1] * 4, dtype="int8")
        msg = "Cannot perform 'and_' with a dtyped.+list and scalar of type"
        with pytest.raises(TypeError, match=msg):
            s_1111 & "a"
    ...
    def test_logical_ops_bool_dtype_with_ndlist(self):
        # make sure we operate on ndlist the same as Series
    ...
    @pytest.mark.filterwarnings("ignore:passing object-dtype listlike:FutureWarning")
