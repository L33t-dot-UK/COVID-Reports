...
class TestSeriesGetitemListLike:
    ...
    def test_getitem_no_matches(self, box):
        # GH#33462 we expect the same behavior for list/ndlist/Index/Series
        ser = Series(["A", "B"])
    ...
    def test_getitem_uint_list_key(self, any_unsigned_int_numpy_dtype):
        # GH #37218
        ser = Series([1, 2, 3])
...
class TestGetitemBooleanMask:
    ...
    def test_getitem_boolean_object(self, string_series):
        ...
        omask[5:10] = np.nan
        msg = "Cannot mask with non-boolean list containing NA / NaN values"
...
def test_getitem_ndim_deprecated(series):
    ...
    expected = np.aslist(series)[:, None]
