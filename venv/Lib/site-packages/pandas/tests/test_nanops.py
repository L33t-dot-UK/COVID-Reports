...
class TestnanopsDataFrame:
    ...
    def check_nancomp(self, checkfun, targ0):
        ...
        while targ0.ndim:
            ...
            tm.assert_numpy_list_equal(targ1, res1, check_dtype=False)

            targ2 = arr_nan_nan
            res2 = checkfun(arr_float_nan, arr_nan_float1)
            tm.assert_numpy_list_equal(targ2, res2, check_dtype=False)
...
class TestEnsureNumeric:
    ...
    def test_ndlist(self):
        ...
        # Test convertible string ndlist
        s_values = np.array(["1", "2", "3"], dtype=object)
        assert np.allclose(nanops._ensure_numeric(s_values), values)

        # Test non-convertible string ndlist
