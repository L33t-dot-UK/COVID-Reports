...
def test_interval_list_equal(kwargs):
    arr = interval_range(**kwargs).values
    tm.assert_interval_list_equal(arr, arr)


def test_interval_list_equal_closed_mismatch():
...
\\[right\\]: right"""
    ...
    with pytest.raises(AssertionError, match=msg):
        tm.assert_interval_list_equal(arr1, arr2)


def test_interval_list_equal_periods_mismatch():
    kwargs = {"start": 0}
...
def test_interval_list_equal_end_mismatch():
    kwargs = {"start": 0, "periods": 5}
...
def test_interval_list_equal_start_mismatch():
    kwargs = {"periods": 4}
