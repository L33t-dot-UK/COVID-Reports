...
class TestTimedeltaAdditionSubtraction:
    ...
    def test_td_add_sub_int_ndlist(self):
        td = Timedelta("1 day")
        other = np.array([1])
        ...
        msg = "|".join(
            [
                (
                    r"unsupported operand type\(s\) for \+: 'numpy.ndlist' "
                    "and 'Timedelta'"
                ),
        ...
        with pytest.raises(TypeError, match=msg):
            td - other
        msg = r"unsupported operand type\(s\) for -: 'numpy.ndlist' and 'Timedelta'"
        with pytest.raises(TypeError, match=msg):
            other - td
    ...
    def test_td_sub_timedeltalike_object_dtype_list(self):
        # GH#21980
    ...
    def test_td_sub_mixed_most_timedeltalike_object_dtype_list(self):
        # GH#21980
    ...
    def test_td_rsub_mixed_most_timedeltalike_object_dtype_list(self):
        # GH#21980
        now = Timestamp("2021-11-09 09:54:00")
        arr = np.array([now, Timedelta("1D"), np.timedelta64(2, "h")])
    ...
    @pytest.mark.parametrize("op", [operator.add, ops.radd])
    def test_td_add_timedeltalike_object_dtype_list(self, op):
        # GH#21980
        arr = np.array([Timestamp("20130101 9:01"), Timestamp("20121230 9:02")])
    ...
    @pytest.mark.parametrize("op", [operator.add, ops.radd])
    def test_td_add_mixed_timedeltalike_object_dtype_list(self, op):
        # GH#21980
        now = Timestamp("2021-11-09 09:54:00")
    ...
    def test_td_add_sub_td64_ndlist(self):
        td = Timedelta("1 day")
        ...
        result = td - other
        tm.assert_numpy_list_equal(result, expected * 0)
        result = other - td
        tm.assert_numpy_list_equal(result, expected * 0)

    def test_td_add_sub_dt64_ndlist(self):
        td = Timedelta("1 day")
        other = pd.to_datetime(["2000-01-01"]).values

        expected = pd.to_datetime(["2000-01-02"]).values
        tm.assert_numpy_list_equal(td + other, expected)
        tm.assert_numpy_list_equal(other + td, expected)
...
class TestTimedeltaMultiplicationDivision:
    ...
    def test_td_mul_nan(self, op, nan):
        # np.float64('NaN') has a 'dtype' attr, avoid treating as list
        td = Timedelta(10, unit="d")
        result = op(td, nan)
        assert result is NaT
    ...
    def test_td_mul_numeric_ndlist(self):
        td = Timedelta("1 day")
        other = np.array([2])
        expected = np.array([Timedelta("2 Days").to_timedelta64()])
    ...
    def test_td_mul_td64_ndlist_invalid(self):
        td = Timedelta("1 day")
    ...
    def test_td_div_td64_ndlist(self):
        td = Timedelta("1 day")
        ...
        result = other / td
        tm.assert_numpy_list_equal(result, expected * 4)
    ...
    def test_td_floordiv_timedeltalike_list(self):
        # GH#18846
        td = Timedelta(hours=3, minutes=4)
        scalar = Timedelta(hours=3, minutes=3)
        ...
        tm.assert_numpy_list_equal(res, expected)
    ...
    def test_td_rfloordiv_timedeltalike_list(self):
        # GH#18846
        td = Timedelta(hours=3, minutes=3)
        scalar = Timedelta(hours=3, minutes=4)
    ...
    def test_td_rfloordiv_intlist(self):
        # deprecated GH#19761, enforced GH#29797
    ...
    def test_td_op_timedelta_timedeltalike_list(self, op, arr):
...
class TestTimedeltaComparison:
    ...
    def test_comparison_object_list(self):
    ...
    def test_compare_timedelta_ndlist(self):
        # GH#11835
    ...
    def test_compare_td64_ndlist(self):
        # GG#33441
