...
class TestTimestampComparison:
    def test_comparison_dt64_ndlist(self, fixed_now_ts):
        ...
        result = arr < ts2
        tm.assert_numpy_list_equal(result, np.array([[False, False]], dtype=bool))

        result = ts2 <= arr
        tm.assert_numpy_list_equal(result, np.array([[True, True]], dtype=bool))
        ...
        result = arr >= ts
        tm.assert_numpy_list_equal(result, np.array([[True, False]], dtype=bool))

    @pytest.mark.parametrize("reverse", [True, False])
    def test_comparison_dt64_ndlist_tzaware(self, reverse, comparison_op):
    ...
    def test_compare_zerodim_list(self, fixed_now_ts):
        # GH#26916
        ts = fixed_now_ts
