...
class TestDataFramePlotsSubplots(TestPlotBase):
    ...
    def test_bar_log_subplots(self):
        ...
        tm.assert_numpy_list_equal(ax[0].yaxis.get_ticklocs(), expected)
        tm.assert_numpy_list_equal(ax[1].yaxis.get_ticklocs(), expected)
    ...
    def test_subplots_sharex_false(self):
        ...
        tm.assert_numpy_list_equal(axs[0].get_xticks(), expected_ax1)
        tm.assert_numpy_list_equal(axs[1].get_xticks(), expected_ax2)
    ...
    def test_bar_barwidth_position_int(self):
        ...
        for w in [1, 1.0]:
            ...
            tm.assert_numpy_list_equal(ticks, np.array([0, 1, 2, 3, 4]))
