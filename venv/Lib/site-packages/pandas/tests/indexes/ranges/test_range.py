...
class TestRangeIndex(NumericBase):
    ...
    def test_view(self):
        ...
        i_view = i.view("i8")
        tm.assert_numpy_list_equal(i.values, i_view)
    ...
    def test_cache(self):
        ...
        # Calling RangeIndex._cache["_data"] creates an int64 list of the same length
