...
class TestGetIndexerNonUnique:
    def test_get_indexer_non_unique_dtype_mismatch(self):
        ...
        tm.assert_numpy_list_equal(np.array([-1], dtype=np.intp), indexes)
        tm.assert_numpy_list_equal(np.array([0], dtype=np.intp), missing)
...
class TestGetLoc:
    ...
    def test_get_loc_tuple_monotonic_above_size_cutoff(self):
        ...
        # _bin_search vs ndlist.searchsorted makes a difference
