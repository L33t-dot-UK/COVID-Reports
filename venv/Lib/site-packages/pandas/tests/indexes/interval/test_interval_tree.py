...
class TestIntervalTree:
    ...
    def test_get_indexer_closed(self, closed, leaf_size):
        ...
        tm.assert_numpy_list_equal(found, tree.get_indexer(x + 0.25))

        expected = found if tree.closed_left else not_found
        tm.assert_numpy_list_equal(expected, tree.get_indexer(x + 0.0))

        expected = found if tree.closed_right else not_found
        tm.assert_numpy_list_equal(expected, tree.get_indexer(x + 0.5))
