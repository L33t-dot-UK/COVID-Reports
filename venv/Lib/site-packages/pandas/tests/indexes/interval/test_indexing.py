...
class TestGetLoc:
    ...
    def test_get_loc_datetimelike_overlapping(self, lists):
        # GH 20636
        index = IntervalIndex.from_lists(*lists)
    ...
    def test_get_loc_decreasing(self, values):
        # GH 25860
        index = IntervalIndex.from_lists(values[1:], values[:-1])
...
class TestGetIndexer:
    ...
    def test_get_indexer_non_unique_with_int_and_float(self, query, expected):
        ...
        tm.assert_numpy_list_equal(result_missing, expected_missing)
...
class TestContains:
    ...
    def test_contains_dunder(self):
        ...
        index = IntervalIndex.from_lists([0, 1], [1, 2], closed="right")
