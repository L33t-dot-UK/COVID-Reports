...
class TestReindex:
    def test_reindex_list_non_unique(self):
        ...
        tm.assert_numpy_list_equal(indexer, np.array([0, 3, 2], dtype=np.intp))
    ...
    def test_reindex_duplicate_target(self):
        ...
        tm.assert_index_equal(res, exp, exact=True)
        tm.assert_numpy_list_equal(indexer, np.array([0, 2, 2], dtype=np.intp))
    ...
    def test_reindex_empty_index(self):
        ...
        tm.assert_numpy_list_equal(indexer, np.array([-1, -1], dtype=np.intp))
