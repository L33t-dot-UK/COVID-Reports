...
class TestCategoricalIndex(Base):
    ...
    def test_drop_duplicates(self, data, categories, expected):
        ...
        for keep, e in expected.items():
            tm.assert_numpy_list_equal(idx.duplicated(keep=keep), e)
            e = idx[~e]
    ...
    def test_isin(self):
        ...
        # mismatched categorical -> coerced to ndlist so doesn't matter
...
class TestCategoricalIndex2:
    ...
    def test_engine_type(self, dtype, engine_type):
        if dtype != np.int64:
            ...
            arr = ci.values._ndlist.astype("int64")
