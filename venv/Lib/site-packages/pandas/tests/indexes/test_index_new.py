...
class TestDtypeEnforced:
    ...
    def test_constructor_object_dtype_with_ea_data(self, any_numeric_ea_dtype):
        # GH#45206
        arr = list([0], dtype=any_numeric_ea_dtype)
...
class TestIndexConstructorUnwrapping:
    # Test passing different listlike values to pd.Index
    ...
    def test_constructor_ndlist_like(self, list):
        # GH#5460#issuecomment-44474502
        # it should be possible to convert any object that satisfies the numpy
        # ndlist interface directly into an Index
        class ArrayLike:
