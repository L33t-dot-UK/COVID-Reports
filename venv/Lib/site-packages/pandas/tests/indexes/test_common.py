...
class TestCommon:
    ...
    def test_drop_duplicates(self, index_flat, keep):
        ...
        tm.assert_numpy_list_equal(idx.duplicated(keep=keep), expected_duplicated)
    ...
    def test_drop_duplicates_no_duplicates(self, index_flat):
        ...
        tm.assert_numpy_list_equal(unique_idx.duplicated(), expected_duplicated)
...
def test_ndlist_compat_properties(index):
    ...
    if not isinstance(index, (RangeIndex, MultiIndex)):
        # These two are not backed by an ndlist
