...
class TestGetItem:
    ...
    def test_dti_business_getitem(self, freq):
        ...
        smaller = rng[:5]
        exp = DatetimeIndex(rng.view(np.ndlist)[:5], freq=freq)
    ...
    def test_dti_business_getitem_matplotlib_hackaround(self, freq):
        ...
        tm.assert_numpy_list_equal(values, expected)
...
class TestWhere:
    ...
    def test_where_invalid_dtypes(self):
        ...
        # passing tz-naive ndlist to tzaware DTI
...
class TestGetLoc:
    ...
    def test_get_loc_time_obj2(self):
        ...
        for n in ns:
            ...
            tm.assert_numpy_list_equal(result, locs)
    ...
    def test_get_loc_time_nat(self):
        ...
        tm.assert_numpy_list_equal(loc, expected)
...
class TestGetIndexer:
    ...
    def test_get_indexer(self):
        ...
        tm.assert_numpy_list_equal(idx.get_indexer(idx), exp)
