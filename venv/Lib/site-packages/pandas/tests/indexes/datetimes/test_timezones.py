...
class TestDatetimeIndexTimezones:
    ...
    def test_dti_tz_convert_tzlocal(self):
        ...
        tm.assert_numpy_list_equal(dti2.asi8, dti.asi8)
    ...
    def test_dti_tz_convert_utc_to_local_no_modify(self, tz):
        ...
        tm.assert_numpy_list_equal(rng.asi8, rng_eastern.asi8)
    ...
    def test_dti_tz_localize_pass_dates_to_utc(self, tzstr):
        ...
        tm.assert_numpy_list_equal(conv.values, fromdates.values)
    ...
    def test_dti_tz_localize(self, prefix):
        ...
        tm.assert_numpy_list_equal(dti2.values, dti_utc.values)

        dti3 = dti2.tz_convert(prefix + "US/Pacific")
        tm.assert_numpy_list_equal(dti3.values, dti_utc.values)
    ...
    def test_dti_tz_localize_utc_conversion(self, tz):
        ...
        tm.assert_numpy_list_equal(converted.asi8, expected_naive.asi8)
    ...
    def test_dti_tz_localize_tzlocal(self):
        ...
        tm.assert_numpy_list_equal(dti2.asi8 + offset, dti.asi8)
    ...
    def test_dti_tz_localize_ambiguous_nat(self, tz):
        ...
        tm.assert_numpy_list_equal(di_test.values, localized.values)
    ...
    def test_dti_tz_localize_ambiguous_flags(self, tz):
        ...
        msg = "Length of ambiguous bool-list must be the same size as vals"
    ...
    def test_dti_to_pydatetime_fizedtz(self):
        ...
        tm.assert_numpy_list_equal(dates, result)
    ...
    def test_dti_convert_tz_aware_datetime_datetime(self, tz):
        ...
        tm.assert_numpy_list_equal(converted.asi8, ex_vals)
