...
class TestDatetimeIndex:
    ...
    def test_shallow_copy_inherits_list_freq(self, index):
        # If we pass a DTA/TDA to shallow_copy and dont specify a freq,
        #  we should inherit the list's freq, not our own.
        list = index._data
    ...
    def test_dti_with_period_data_raises(self):
        ...
        with pytest.raises(TypeError, match="PeriodDtype data is invalid"):
            DatetimeIndex(period_list(data))

        with pytest.raises(TypeError, match="PeriodDtype data is invalid"):
            to_datetime(period_list(data))
    ...
    def test_construction_with_ndlist(self):
        # GH 5152
    ...
    def test_constructor_datetime64_tzformat(self, freq):
        ...
        tm.assert_numpy_list_equal(idx.asi8, expected_i8.asi8)
    ...
    def test_index_constructor_with_numpy_object_list_and_timestamp_tz_with_nan(self):
        # GH 27011
...
class TestTimeSeries:
    ...
    def test_pass_datetimeindex_to_index(self):
        ...
        tm.assert_numpy_list_equal(idx.values, expected.values)
