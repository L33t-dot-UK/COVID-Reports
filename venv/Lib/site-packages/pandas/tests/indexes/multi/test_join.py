...
def test_join_level(idx, other, join_type):
    ...
    tm.assert_numpy_list_equal(join_index.values, exp_values)
    ...
    if join_type in ("outer", "inner"):
        ...
        tm.assert_numpy_list_equal(lidx, lidx2)
        tm.assert_numpy_list_equal(ridx, ridx2)
        tm.assert_numpy_list_equal(join_index2.values, exp_values)
