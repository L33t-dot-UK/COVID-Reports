...
class TestGetIndexer:
    ...
    def test_get_indexer_nearest(self, method, tolerance, indexer, expected):
        ...
        tm.assert_numpy_list_equal(actual, np.array(expected, dtype=np.intp))
    ...
    def test_get_indexer_nearest_decreasing(self, method, expected):
        ...
        tm.assert_numpy_list_equal(actual, np.array([9, 4, 0], dtype=np.intp))
    ...
    def test_get_indexer_numeric_index_boolean_target(self, method, idx_class):
        ...
        if method == "get_indexer":
            ...
            tm.assert_numpy_list_equal(result[0], expected)
            tm.assert_numpy_list_equal(result[1], missing)
