...
class TestPeriodIndex(DatetimeLike):
    ...
    def test_view_asi8(self):
        ...
        tm.assert_numpy_list_equal(idx.view("i8"), exp)
        tm.assert_numpy_list_equal(idx.asi8, exp)
    ...
    def test_values(self):
        ...
        tm.assert_numpy_list_equal(idx.values, exp)
        tm.assert_numpy_list_equal(idx.to_numpy(), exp)
    ...
    def test_with_multi_index(self):
        ...
        index_as_lists = [index.to_period(freq="D"), index.hour]

        s = Series([0, 1, 2, 3], index_as_lists)
...
def test_dunder_list(list):
    ...
    for dtype in ["i8", "int64", np.int64]:
        ...
        result = np.aslist(obj, dtype=dtype)
        tm.assert_numpy_list_equal(result, expected)
