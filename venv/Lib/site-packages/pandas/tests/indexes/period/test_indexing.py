...
class TestGetLoc:
    ...
    def test_get_loc(self):
        ...
        tm.assert_numpy_list_equal(idx2.get_loc(p2), expected_idx2_p2)
        tm.assert_numpy_list_equal(idx2.get_loc(str(p2)), expected_idx2_p2)
...
class TestGetIndexer:
    def test_get_indexer(self):
        ...
        tm.assert_numpy_list_equal(res, np.array([0, 0, 1, -1], dtype=np.intp))
    ...
    def test_get_indexer_non_unique(self):
        ...
        tm.assert_numpy_list_equal(result[0], expected_indexer)
        tm.assert_numpy_list_equal(result[1], expected_missing)
