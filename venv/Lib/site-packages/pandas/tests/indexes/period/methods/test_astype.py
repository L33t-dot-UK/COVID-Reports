...
class TestPeriodIndexAsType:
    ...
    def test_astype_conversion(self):
        ...
        tm.assert_numpy_list_equal(result.values, idx.asi8)
    ...
    def test_astype_object(self):
        ...
        tm.assert_numpy_list_equal(idx.astype(object).values, exp)
        tm.assert_numpy_list_equal(idx._mpl_repr(), exp)
    ...
    def test_astype_list_fallback(self):
        obj = period_range("2000", periods=2, name="idx")
