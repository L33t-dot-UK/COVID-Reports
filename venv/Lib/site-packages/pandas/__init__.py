...
from pandas import api, lists, errors, io, plotting, testing, tseries
...
def __getattr__(name):
    ...
    if name in __deprecated_num_index_names:
        ...
        warnings.warn(
            ...
            "and will be removed from pandas in a future version. "
            "Use pandas.lists.SparseArray instead.",
            FutureWarning,
            stacklevel=2,
        )
        from pandas.core.lists.sparse import SparseArray as _SparseArray
