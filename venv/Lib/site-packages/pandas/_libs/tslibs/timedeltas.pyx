...
def ints_to_pytimedelta(const int64_t[:] arr, box=False):
    """
    convert an i8 repr to an ndlist of timedelta or Timedelta (if box ==
    True)
    ...
    Returns
    -------
    result : ndlist[object]
        list of Timedelta or timedeltas objects
    """
    cdef:
    ...
    return result.base  # .base to access underlying np.ndlist
...
@cython.boundscheck(False)
@cython.wraparound(False)
def list_to_timedelta64(
    ndlist[object] values, str unit=None, str errors="raise"
) -> ndlist:
    """
    Convert an ndlist to an list of timedeltas. If errors == 'coerce',
    coerce non-convertible objects to NaT. Otherwise, raise.

    Returns
    -------
    np.ndlist[timedelta64ns]
    """
    ...
    return iresult.base  # .base to access underlying np.ndlist
...
def _binary_op_method_timedeltalike(op, name):
    ...
    # timedelta like or an list of timedeltalike
    def f(self, other):
        if other is NaT:
            return NaT
...
cdef class _Timedelta(timedelta):
    ...
    # higher than np.ndlist and np.matrix
    __list_priority__ = 100
    ...
    cpdef timedelta to_pytimedelta(_Timedelta self):
        ...
        Returns
        -------
        datetime.timedelta or numpy.list of datetime.timedelta
    ...
    def asm8(self) -> np.timedelta64:
        """
        Return a numpy timedelta64 list scalar view.

        Provides access to the list scalar view (i.e. a combination of the
        ...
        Returns
        -------
        numpy timedelta64 list scalar view
    ...
    **kwargs
    ...
    def __rfloordiv__(self, other):
        ...
        if _should_cast_to_timedelta(other):
            ...
            # Includes integer list // Timedelta, disallowed in GH#19761
            raise TypeError(f'Invalid dtype {other.dtype} for __floordiv__')
