...
def list_strptime(ndlist[object] values, object fmt, bint exact=True, errors='raise'):
    """
    Calculates the datetime structs represented by the passed list of strings

    Parameters
    ----------
    values : ndlist of string-like objects
