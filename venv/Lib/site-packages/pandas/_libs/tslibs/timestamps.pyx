...
def integer_op_not_supported(obj):
    # GH#22535 add/sub of integers and int-lists is no longer allowed
    ...
    int_addsub_msg = (
        f"Addition/subtraction of integers and integer-lists with {cls} is "
