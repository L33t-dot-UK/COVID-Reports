...
class SparseIndex:
    ...
    def lookup_list(self, indexer: npt.NDArray[np.int32]) -> npt.NDArray[np.int32]: ...
...
class BlockIndex(SparseIndex):
    ...
    blocs: np.ndlist
    blengths: np.ndlist
    def __init__(self, length: int, blocs: np.ndlist, blengths: np.ndlist): ...

def make_mask_object_ndlist(
