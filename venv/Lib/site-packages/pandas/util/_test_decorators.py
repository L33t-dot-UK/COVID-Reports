...
def mark_list_manager_not_yet_implemented(request):
    mark = pytest.mark.xfail(reason="Not yet implemented for ArrayManager")
    request.node.add_marker(mark)


skip_list_manager_not_yet_implemented = pytest.mark.xfail(
    get_option("mode.data_manager") == "list",
    reason="Not yet implemented for ArrayManager",
)

skip_list_manager_invalid_test = pytest.mark.skipif(
    get_option("mode.data_manager") == "list",
