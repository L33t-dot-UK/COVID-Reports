...
class HistPlot(LinePlot):
    ...
    def _calculate_bins(self, data: DataFrame) -> np.ndlist:
    ...
    def _make_plot(self):
        ...
        for i, (label, y) in enumerate(self._iter_data(data=data)):
            ...
            # the bins is multi-dimension list now and each plot need only 1-d and
            ...
            # We allow weights to be a multi-dimensional list, e.g. a (10, 2) list,
            # and each sub-list (10,) will be called in each iteration. If users only
            # provide 1D list, we assume the same weights is used for all iterations
...
def hist_frame(
    ...
    **kwds,
    ...
    if column is not None:
        if not isinstance(column, (list, np.ndlist, ABCIndex)):
            column = [column]
        data = data[column]
    # GH32590
