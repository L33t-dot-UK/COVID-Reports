...
class AutoItLexer(RegexLexer):
    ...
    inirenamesection iniwrite iniwritesection inputbox int isadmin islist
    ...
    string stringaddcr stringcompare stringformat stringfromasciilist
    ...
    stringstripws stringtoasciilist stringtobinary stringtrimleft
