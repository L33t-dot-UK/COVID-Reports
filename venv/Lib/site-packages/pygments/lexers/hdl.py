    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                '$async$and$list', '$async$and$plane', '$async$nand$list',
                '$async$nand$plane', '$async$nor$list', '$async$nor$plane',
                '$async$or$list', '$async$or$plane', '$sync$and$list',
                '$sync$and$plane', '$sync$nand$list', '$sync$nand$plane',
                '$sync$nor$list', '$sync$nor$plane', '$sync$or$list',
                '$sync$or$plane',
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                ...
                'architecture', 'list', 'assert', 'attribute', 'begin', 'block',
