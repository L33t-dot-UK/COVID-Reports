...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                '__import__', 'abs', 'all', 'any', 'bin', 'bool', 'bytelist',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'bool', 'buffer', 'bytelist', 'bytes', 'callable', 'chr', 'classmethod',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'bool', 'buffer', 'bytelist', 'bytes', 'callable', 'chr',
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (words((
                'bool', 'bytelist', 'bytes', 'classmethod', 'complex', 'dict', 'dict\'',
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'argsort', 'argwhere', 'around', 'list', 'list2string', 'list_equal',
        'list_equiv', 'list_repr', 'list_split', 'list_str', 'listrange',
        'asanylist', 'aslist', 'aslist_chkfinite', 'ascontiguouslist',
        'asflist', 'asfortranlist', 'asmatrix', 'asscalar', 'astype',
        'atleast_1d', 'atleast_2d', 'atleast_3d', 'average', 'bartlett',
        'base_repr', 'beta', 'binary_repr', 'bincount', 'binomial',
        'bitwise_and', 'bitwise_not', 'bitwise_or', 'bitwise_xor', 'blackman',
        'bmat', 'broadcast', 'byte_bounds', 'bytes', 'byteswap', 'c_',
        'can_cast', 'ceil', 'choose', 'clip', 'column_stack', 'common_type',
        'compare_charlists', 'compress', 'concatenate', 'conj', 'conjugate',
        ...
        'floor', 'floor_divide', 'fmod', 'frexp', 'fromlists', 'frombuffer',
        'fromfile', 'fromfunction', 'fromiter', 'frompyfunc', 'fromstring',
        'generic', 'get_list_wrap', 'get_include', 'get_numlist_include',
        ...
        'reclist', 'reciprocal', 'reduce', 'remainder', 'repeat', 'require',
