    ...
    tokens = {
        'statements': [
            ...
            (r'(bool|int|long|float|short|double|char|string|object|void|mapping|'
             r'list|multiset|program|function|lambda|mixed|'
             r'[a-z_][a-z0-9_]*_t)\b',
             Keyword.Type),
...
class ArduinoLexer(CppLexer):
    ...
    variables = {
        ...
        'list', 'static', 'volatile', 'const', 'boolean', 'byte', 'word', 'string',
        'String', 'list', 'int', 'float', 'private', 'char', 'virtual', 'operator',
...
class CharmciLexer(CppLexer):
    ...
    tokens = {
        'keywords': [
            ...
            (words(('mainmodule', 'mainchare', 'chare', 'list', 'group',
