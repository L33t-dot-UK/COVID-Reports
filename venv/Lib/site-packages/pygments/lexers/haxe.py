...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'expr': [
            ...
            # Array
            (r'\[', Punctuation, ('#pop', 'expr-chain', 'list-decl')),
        ],
        ...
        'list-decl': [
            include('spaces'),
            (r'\]', Punctuation, '#pop'),
            default(('#pop', 'list-decl-sep', 'expr')),
        ],

        'list-decl-sep': [
            include('spaces'),
            (r'\]', Punctuation, '#pop'),
            (r',', Punctuation, ('#pop', 'list-decl')),
        ],

        'list-access': [
            include('spaces'),
            default(('#pop', 'list-access-close', 'expr')),
        ],
