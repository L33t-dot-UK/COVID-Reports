...
class FactorLexer(RegexLexer):
    ...
    builtin_kernel = words((
        ...
        'build', 'call', 'callstack', 'callstack>list', 'callstack?', 'clear', '(clone)',
    ...
    builtin_lists = words((
        '1list', '2list', '3list', '4list', '<list>', '>list', 'list',
        'list?', 'pair', 'pair?', 'resize-list'), suffix=r'(\s+)')
    ...
    tokens = {
        ...
        'base': [
            ...
            (builtin_lists, bygroups(Name.Builtin, Whitespace)),
