...
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.getNewCases(), "orange", "New Cases", False, True) #LoadDataSets will give 2 date lists getGOVdateSeries and getAgedGOVdateSeries; one is to be used with non aged data and the other for age profiled data
...
chart.add_scatter_plot(govData.fullDataFrame["date"], govData.fullDataFrame["newCasesBySpecimenDate"], "orange", "New Cases", False, True) #LoadDataSets will give 2 date lists getGOVdateSeries and getAgedGOVdateSeries; one is to be used with non aged data and the other for age profiled data
#chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newCasesBySpecimenDate"], "orange", "New Cases", False, True) #VLINES would be drawn using this line
...
chart.clear_chart() #Always clear the chart before creating a new one
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newDeaths28DaysByPublishDate"], "red", "Deaths", False, False) #LoadDataSets will give 2 date lists getGOVdateSeries and getAgedGOVdateSeries; one is to be used with non aged data and the other for age profiled data
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newAdmissions"], "purple", "Hospital Cases", False, False) #VLINES would be drawn using this line
...
chart.clear_chart() #Always clear the chart before creating a new one
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newDeaths28DaysByPublishDate"], "red", "Deaths 7 Day Average", False, False) #LoadDataSets will give 2 date lists getGOVdateSeries and getAgedGOVdateSeries; one is to be used with non aged data and the other for age profiled data
chart.set_LOBF_time(56)
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newDeaths28DaysByPublishDate"], "red", "Deaths 56 Day Average", True, False)
...
chart.clear_chart() #Always clear the chart before creating a new one
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newDeaths28DaysByDeathDate"], "red", "Deaths by Death Date", False, False) #LoadDataSets will give 2 date lists getGOVdateSeries and getAgedGOVdateSeries; one is to be used with non aged data and the other for age profiled data
chart.add_scatter_plot(govData.getGOVdateSeries(), govData.fullDataFrame["newDeaths28DaysByPublishDate"], "blue", "Deaths by Reported Date", True, False)
