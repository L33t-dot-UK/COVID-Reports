...
<p>This toolset was designed to create the charts found at https://www.COVIDreports.uk. It takes data from the government dashboard using version 1 of their API, cleans and processes it ready for use within Python</p>
